...
I specialize in engineering resilient backend systems, scalable cloud infrastructure, and impactful healthcare technology solutions. Passionate about bridging low-level system design with clean UI/UX.

* 🎯 **Core Focus:** Backend Architecture, High-Availability Systems, and Distributed Storage
* 🏥 **Current Pursuit:** Building scalable healthcare tech with fault-tolerant backends
* 🧠 **Algorithmic Foundation:** Strong background in Data Structures & Algorithms (DSA)
